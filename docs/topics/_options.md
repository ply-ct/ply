...
| **<code>genExcludeResponseHeaders</code>**<br>**<code>--genExcludeResponseHeaders</code>** | `cache-control, connection, content-length, date, etag, x-powered-by` | Response headers to exclude when generating expected results.
